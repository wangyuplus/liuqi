...
<%-- <!-- 教师的登陆界面 -->
    ...
    <div class="top-content">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="${pageContext.request.contextPath}/teacher/login" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" id="userNo" name="userNo" placeholder="工号：" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
      ...
      <div class="copyrights">版权所有：西安邮电大学计算机学院  刘琦 2020</div>
        <!-- Javascript -->
