...
public interface IStudentService {
	...
	void uploadInterimReport(int studentId,String filePath);

	InterimReport findInterimReport(int studentId);

    void uploadSystemCode(int studentId, String s);

    SystemCode findSystemCode(int studentId);

	void uploadTranslation(int studentId, String s);

	Translation findTranslation(int studentId);

	void uploadEnclosure(int studentId, String s);
